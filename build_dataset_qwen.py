...
Pipeline:
  ...
  6. Tokenize with Qwen3 tokenizer, pack into 4096-token sequences with EOS separators
  7. Save as HuggingFace Dataset
  8. Write dataset_stats_qwen.md
"""
...
def write_stats(
    ...
    lines = [
        ...
        "",
        "## Token Counts (per article, Qwen3 tokenizer)",
...
def main():
    ...
    vocab_size = len(tokenizer)  # includes added special tokens (e.g. EOS)
    errors = []
